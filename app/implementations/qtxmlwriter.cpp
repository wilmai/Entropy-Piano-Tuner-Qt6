...
QtXmlWriter::QtXmlWriter()
    : XmlWriterInterface(), mString(), mWriter(&mString) {

  mWriter.setAutoFormatting(true);
}

bool QtXmlWriter::open() { return mWriter.hasError() == false; }

std::wstring QtXmlWriter::close() { return mString.toStdWString(); }

bool QtXmlWriter::hasError() { return mWriter.hasError(); }

void QtXmlWriter::writeStartDocument() { mWriter.writeStartDocument(); }

void QtXmlWriter::writeEndDocument() { mWriter.writeEndDocument(); }

void QtXmlWriter::writeStartElement(const std::string &name) {
  mWriter.writeStartElement(QString::fromStdString(name));
}

void QtXmlWriter::writeEndElement() { mWriter.writeEndElement(); }
...
void QtXmlWriter::writeAttribute(const std::string &name,
                                 const std::string &value) {
  mWriter.writeAttribute(QString::fromStdString(name),
...
void QtXmlWriter::writeTextElement(const std::string &name,
                                   const std::string &value) {
  mWriter.writeTextElement(QString::fromStdString(name),
                           QString::fromStdString(value));
}
...
void QtXmlWriter::writeDoubleListElement(const std::string &name,
