...
static const std::string SERVER_DOMAIN = "localhost";
static const std::string SERVER_ADDRESS = "http://" + SERVER_DOMAIN;
static const std::string SERVER_NAME = "www." + SERVER_DOMAIN;
static const std::string SERVER_DOWNLOADS_ADDRESS = "";
static const std::string SERVER_DOCUMENTATION_ADDRESS = "";
static const std::string MAIL_ADDRESS = "";
...
extern std::string EPT_EXTERN
getDownloadsFileAddress(const std::string &filename);
